  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-20 flex items-center justify-between mb-10">
        <h3 className="text-3xl lg:text-4xl font-bold tracking-tight italic font-display">{t("theArchive")}</h3>
        <p className="text-gray-500 font-medium tracking-wide uppercase text-xs lg:text-sm">{t("sortedByRecent")}</p>
      </div>
      ...
      <section className="mt-20 py-24 bg-gray-50 text-center px-6">
        <div className="max-w-xl mx-auto">
          <h3 className="text-3xl lg:text-4xl font-bold italic mb-4 font-display">{t("joinCollective")}</h3>
