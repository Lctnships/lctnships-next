  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
      ...
      <button
        ...
        className="w-full sm:w-auto px-8 py-4 bg-primary text-white font-extrabold rounded-full hover:shadow-xl hover:brightness-105 active:scale-95 transition-all"
      >
        {buttonText}
      </button>
    </div>
