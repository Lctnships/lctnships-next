    ...
    <div className="min-h-screen bg-[#f6f6f8]">
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-10 py-6 md:py-10">
        <div className="flex flex-col sm:flex-row justify-between sm:items-end gap-4 mb-8">
          <div>
            <h1 className="text-2xl md:text-3xl font-extrabold tracking-tight text-[#0d121b]">{t("title")}</h1>
            <p className="text-[#4c669a] mt-1 font-medium text-sm md:text-base">{t("subtitle")}</p>
          </div>
          <Link
            href="/studios"
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-10">
            ...
            <div className="flex flex-col gap-6">
              {filteredBookings.length === 0 ? (
                <div className="bg-white rounded-xl border border-[#e7ebf3] p-12 text-center">
                  ...
                  <h3 className="text-lg font-bold text-[#0d121b] mb-2">{t("emptyTitle")}</h3>
          ...
          <aside className="hidden lg:flex w-80 flex-col gap-8">
            ...
            <div className="bg-white rounded-xl p-8 border border-[#e7ebf3] shadow-sm text-center">
              ...
              <p className="text-[#4c669a] text-sm font-bold uppercase tracking-wider mb-2">{t("totalHoursBooked")}</p>
              ...
              <p className="text-[11px] text-[#4c669a] mt-2">{Math.round((totalHours / 200) * 100)}{t("yearlyGoalProgress")}</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-[#e7ebf3] shadow-sm">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/favorites" className="text-[#2b6cee] text-xs font-bold hover:underline">{t("viewAll")}</Link>
              </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4 md:gap-6 mt-4 md:mt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-[#4c669a] uppercase font-bold tracking-tighter">{t("date")}</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-[#4c669a] uppercase font-bold tracking-tighter">{t("time")}</p>
                ...
                <>
                  {!booking.has_review ? (
                    ...
                    <div className="flex items-center justify-center gap-1.5 bg-yellow-50 text-yellow-700 px-6 py-2.5 rounded-full">
                      ...
                      <span className="text-xs font-bold ml-1 opacity-70">{t("reviewed")}</span>
                    </div>
                  )}
                  <Link
