  ...
  return (
    <div className="min-h-screen bg-[#f6f6f8]">
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-10 py-6 md:py-10">
        ...
        <Link
          href="/studios"
          className="bg-black hover:bg-gray-800 text-white rounded-full px-6 py-3 text-sm font-bold flex items-center gap-2 transition-all w-fit"
        >
          <span className="material-symbols-outlined text-lg">add</span>
          {t("bookStudio")}
        </Link>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 min-w-0">
          {/* Search */}
          <div className="mb-6">
            <div className="flex w-full max-w-md items-stretch rounded-full bg-white border border-gray-200 overflow-hidden focus-within:border-gray-400 transition-colors">
              <div className="flex items-center justify-center pl-4 text-gray-400">
                <span className="material-symbols-outlined text-xl">search</span>
              </div>
              <input
            ...
            <div className="flex border-b border-gray-200 gap-8 overflow-x-auto">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`flex items-center gap-2 border-b-2 pb-3 px-1 text-sm font-bold tracking-wide transition-colors whitespace-nowrap ${
                    activeTab === tab.key
                      ? "border-black text-black"
                      : "border-transparent text-gray-400 hover:text-gray-700"
                  }`}
          ...
          <div className="overflow-y-auto max-h-[calc(100vh-320px)] pb-4">
            <div className="flex flex-col gap-5">
            {filteredBookings.length === 0 ? (
