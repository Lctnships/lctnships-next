...
export function ProjectWorkspaceClient({
  ...
  const tabs = [
    { id: "bookings" as const, label: t("tabBookings"), icon: "event_available" },
    { id: "storyboard" as const, label: t("tabStoryboard"), icon: "view_quilt" },
    { id: "moodboard" as const, label: t("tabMoodboard"), icon: "palette" },
    { id: "shotlist" as const, label: t("tabShotlist"), icon: "list_alt" },
    { id: "team" as const, label: t("tabTeam"), icon: "group" },
    { id: "files" as const, label: t("tabFiles"), icon: "folder" },
  ]
      ...
      <div className="flex gap-8">
        ...
        <div className="flex-1">
          ...
          {activeTab === "storyboard" && (
            <>
              <div className="flex justify-between items-center mb-8">
                <div className="flex items-center gap-4">
                  <h2 className="text-2xl font-bold">{t("storyboardHeading")}</h2>
                  <div className="bg-gray-100 px-3 py-1 rounded-full text-xs font-bold text-gray-500">
                    {storyboardFrames.length} {t("storyboardFrames")}
                  </div>
                </div>
                <div className="flex gap-3">
          ...
          {activeTab === "files" && (
            <>
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-bold">{t("filesHeading")}</h2>
                <div className="flex gap-2">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
                <table className="w-full text-left text-sm">
                  <thead className="bg-gray-50 border-b border-gray-100 text-gray-500">
                    <tr>
                      <th className="px-6 py-4 font-bold">{t("fileName")}</th>
                      <th className="px-6 py-4 font-bold">{t("fileKind")}</th>
                      <th className="px-6 py-4 font-bold">{t("fileSize")}</th>
                      <th className="px-6 py-4 font-bold">{t("fileModified")}</th>
                    ...
                    {files.map((file) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-gray-500">
                          {file.type.toUpperCase()} {file.type === "image" ? t("fileImage") : t("fileDocument")}
                        </td>
          ...
          {activeTab === "moodboard" && (
            <div className="text-center py-20">
              ...
              <h3 className="text-xl font-bold mb-2">{t("moodboardComingSoon")}</h3>
              <p className="text-gray-500">{t("moodboardDescription")}</p>
            </div>
          )}
        </div>
